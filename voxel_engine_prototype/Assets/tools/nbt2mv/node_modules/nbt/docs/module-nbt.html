...
<dl class="details">
    ...
    <h4 class="name" id=".parseUncompressed"><span class="type-signature">(static) </span>parseUncompressed<span class="signature">(data)</span><span class="type-signature"> &rarr; {Object}</span></h4>
...
//               bar: { type: string, value: 'Hi!' }}}</code></pre>
    ...
    <h4 class="name" id=".writeUncompressed"><span class="type-signature">(static) </span>writeUncompressed<span class="signature">(value)</span><span class="type-signature"> &rarr; {ArrayBuffer}</span></h4>
