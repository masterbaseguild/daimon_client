...
public class HookL : Ability
{
    ...
    public HookL(GameObject user) : base(user)
    {
        ...
        GameObject Hook1 = new GameObject("HookL1");
        GameObject Hook2 = new GameObject("HookL2");
    ...
    public override void Start()
    {
        ...
        {
            hookPos = hit.point;
            Debug.Log("Hook Left: from "+userCamera.position+" to "+hookPos+"");
            isHooked = true;
